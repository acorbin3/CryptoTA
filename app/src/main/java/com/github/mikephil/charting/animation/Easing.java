...
public class Easing {
    ...
    private static class EasingFunctions {
        ...
        public static final EasingFunction EaseInQuad = new EasingFunction() {
            // @Override
            // public float ease(long elapsed, long duration) {
            // float valueIndex = elapsed / (float) duration;
        ...
        public static final EasingFunction EaseOutQuad = new EasingFunction() {
            ...
            // public float ease(long elapsed, long duration) {
            // float valueIndex = elapsed / (float) duration;
            // return -valueIndex * (valueIndex - 2.f);
            // }
        ...
        public static final EasingFunction EaseInOutQuad = new EasingFunction() {
            // @Override
            // public float ease(long elapsed, long duration) {
            // float valueIndex = elapsed / (duration / 2.f);
            // if (valueIndex < 1.f)
            // {
            // return 0.5f * valueIndex * valueIndex;
            // }
            // return -0.5f * ((--valueIndex) * (valueIndex - 2.f) - 1.f);
            // }
        ...
        public static final EasingFunction EaseInCubic = new EasingFunction() {
            ...
            // public float ease(long elapsed, long duration) {
            // float valueIndex = elapsed / (float) duration;
            // return valueIndex * valueIndex * valueIndex;
            // }
        ...
        public static final EasingFunction EaseOutCubic = new
                EasingFunction() {
                    ...
                    // float valueIndex = elapsed / (float) duration;
                    // valueIndex--;
                    // return (valueIndex * valueIndex * valueIndex + 1.f);
                    // }
        ...
        public static final EasingFunction EaseInOutCubic = new
                EasingFunction() {
                    ...
                    // if (valueIndex < 1.f)
                    // {
                    // return 0.5f * valueIndex * valueIndex * valueIndex;
                    // }
                    // valueIndex -= 2.f;
                    // return 0.5f * (valueIndex * valueIndex * valueIndex + 2.f);
                    // }
        ...
        public static final EasingFunction EaseInSine = new EasingFunction() {
            ...
            // public float ease(long elapsed, long duration) {
            // float valueIndex = elapsed / (float) duration;
            // return -(float) Math.cos(valueIndex * (Math.PI / 2.f)) + 1.f;
            // }
            @Override
            public float getInterpolation(float input) {
        ...
        public static final EasingFunction EaseOutSine = new EasingFunction() {
            ...
            // public float ease(long elapsed, long duration) {
            // float valueIndex = elapsed / (float) duration;
            // return (float) Math.sin(valueIndex * (Math.PI / 2.f));
            // }
            @Override
            public float getInterpolation(float input) {
        ...
        public static final EasingFunction EaseInOutSine = new EasingFunction() {
            ...
            // public float ease(long elapsed, long duration) {
            // float valueIndex = elapsed / (float) duration;
            // return -0.5f * ((float) Math.cos(Math.PI * valueIndex) - 1.f);
            // }
        ...
        public static final EasingFunction EaseInOutExpo = new
                EasingFunction() {
                    ...
                    // if (valueIndex < 1.f)
                    // {
                    // return 0.5f * (float) Math.pow(2.f, 10.f * (valueIndex - 1.f));
                    // }
                    // return 0.5f * (-(float) Math.pow(2.f, -10.f * --valueIndex) +
                    // 2.f);
                    // }
        ...
        public static final EasingFunction EaseInCirc = new EasingFunction() {
            ...
            // public float ease(long elapsed, long duration) {
            // float valueIndex = elapsed / (float) duration;
            // return -((float) Math.sqrt(1.f - valueIndex * valueIndex) - 1.f);
            // }
        ...
        public static final EasingFunction EaseOutCirc = new EasingFunction() {
            ...
            // float valueIndex = elapsed / (float) duration;
            // valueIndex--;
            // return (float) Math.sqrt(1.f - valueIndex * valueIndex);
            // }
            @Override
            public float getInterpolation(float input) {
                input--;
        ...
        public static final EasingFunction EaseInOutCirc = new
                EasingFunction() {
                    ...
                    // if (valueIndex < 1.f)
                    // {
                    // return -0.5f * ((float) Math.sqrt(1.f - valueIndex * valueIndex)
                    // - 1.f);
                    // }
                    // return 0.5f * ((float) Math.sqrt(1.f - (valueIndex -= 2.f) *
                    // valueIndex)
                    // + 1.f);
                    // }
        ...
        public static final EasingFunction EaseInElastic = new
                EasingFunction() {
                    ...
                    // Math.asin(1.f);
                    // return -((float) Math.pow(2.f, 10.f * (valueIndex -= 1.f)) *
                    // (float)
                    // Math
                    // .sin((valueIndex * duration - s) * (2.f * Math.PI) / p));
                    // }
        ...
        public static final EasingFunction EaseOutElastic = new
                EasingFunction() {
                    ...
                    // return (float) Math.pow(2, -10 * valueIndex)
                    // * (float) Math.sin((valueIndex * duration - s) * (2.f *
                    // Math.PI) / p) +
                    // 1.f;
                    // }
        ...
        public static final EasingFunction EaseInOutElastic = new
                EasingFunction() {
                    ...
                    // {
                    // return -.5f
                    // * ((float) Math.pow(2.f, 10.f * (valueIndex -= 1.f)) * (float)
                    // Math
                    // .sin((valueIndex * duration - s) * (2.f * Math.PI) / p));
                    // }
                    // return (float) Math.pow(2.f, -10.f * (valueIndex -= 1.f))
        ...
        public static final EasingFunction EaseInBack = new EasingFunction()
        {
            ...
            // float valueIndex = elapsed / (float) duration;
            // return valueIndex * valueIndex * ((s + 1.f) * valueIndex - s);
            // }
        ...
        public static final EasingFunction EaseOutBack = new EasingFunction()
        {
            ...
            // float valueIndex = elapsed / (float) duration;
            // valueIndex--;
            // return (valueIndex * valueIndex * ((s + 1.f) * valueIndex + s) + 1.f);
            // }
        ...
        public static final EasingFunction EaseInOutBack = new
                EasingFunction() {
                    ...
                    // if (valueIndex < 1.f)
                    // {
                    // return 0.5f * (valueIndex * valueIndex * (((s *= (1.525f)) + 1.f)
                    // *
                    // valueIndex - s));
                    // }
                    // return 0.5f * ((valueIndex -= 2.f) * valueIndex
                    // * (((s *= (1.525f)) + 1.f) * valueIndex + s) + 2.f);
                    // }
        ...
        public static final EasingFunction EaseOutBounce = new
                EasingFunction() {
                    ...
                    // public float ease(long elapsed, long duration) {
                    // float valueIndex = elapsed / (float) duration;
                    // if (valueIndex < (1.f / 2.75f))
                    // {
                    // return (7.5625f * valueIndex * valueIndex);
                    // }
                    // else if (valueIndex < (2.f / 2.75f))
                    // {
                    // return (7.5625f * (valueIndex -= (1.5f / 2.75f)) * valueIndex +
                    // .75f);
                    // }
                    // else if (valueIndex < (2.5f / 2.75f))
                    // {
                    // return (7.5625f * (valueIndex -= (2.25f / 2.75f)) * valueIndex +
                    // .9375f);
                    // }
                    // else
                    // {
                    // return (7.5625f * (valueIndex -= (2.625f / 2.75f)) * valueIndex +
                    // .984375f);
                    // }
                    // }
