...
public abstract class Utils {
     ...
     * Calculates the valueIndex around a center point, depending on the distance
     * from the center, and the angle of the valueIndex around the center.
     *
     * @param center
     * @param dist
    ...
    public static void drawImage(Canvas canvas,
        ...
        // translate to the correct valueIndex and draw
