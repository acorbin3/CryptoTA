...
public class YAxis extends AxisBase {
    ...
    /**
     * the valueIndex of the y-labels relative to the chart
     */
    private YAxisLabelPosition mPosition = YAxisLabelPosition.OUTSIDE_CHART;

    /**
     * enum for the valueIndex of the y-labels relative to the chart
     */
    ...
    /**
     * returns the valueIndex of the y-labels
     */
    ...
    /**
     * sets the valueIndex of the y-labels
     *
     * @param pos
     */
