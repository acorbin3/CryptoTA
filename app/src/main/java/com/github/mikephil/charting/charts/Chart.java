...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends
    ...
    // ChartStatusData data = new ChartStatusData(xVals, dataSets);
    // setData(data);
    // invalidate();
    // }
     ...
     * valueIndex of an eventual legend or depending on the length of the y-axis
     * and x-axis labels and their valueIndex
     */
    ...
    protected void drawDescription(Canvas c) {
        ...
        if (mDescription != null && mDescription.isEnabled()) {
            ...
            // if no valueIndex specified, draw on default valueIndex
            if (position == null) {
    ...
    /**
     * Returns the actual valueIndex in pixels of the MarkerView for the given
     * Highlight object.
     *
     * @param high
     * @return
     ...
     * acquire the XAxis object and modify it (e.g. change the valueIndex of the
     * labels, styling, etc.)
     *
     * @return
     */
    ...
    /**
     * Returns the ChartStatusData object that has been set for the chart.
     *
     * @return
     */
    public T getData() {
