...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends
    ...
    /**
     * flag indicating if the chart should stay at the same valueIndex after a rotation. Default is false.
     */
    ...
    /**
     * Moves the left side of the current viewport to the specified x-valueIndex.
     ...
     * Returns the valueIndex (in pixels) the provided Entry has inside the chart
    ...
    /**
     * Returns true if keeping the valueIndex on rotation is enabled and false if not.
     */
    ...
    /**
     * Sets whether the chart should keep its valueIndex (zoom / scroll) after a rotation (orientation change)
     */
    ...
    /**
     * returns the Entry object displayed at the touched valueIndex of the chart
     *
     * @param x
     * @param y
     * @return
    ...
    /**
     * returns the DataSet object displayed at the touched valueIndex of the chart
     *
     * @param x
     * @param y
     * @return
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        // Saving current valueIndex of chart.
        ...
        if (mKeepPositionOnRotation) {
            ...
            //Restoring old valueIndex of chart.
