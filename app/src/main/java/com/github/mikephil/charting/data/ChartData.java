...
public abstract class ChartData<T extends IDataSet<? extends Entry>> {
    ...
    /**
     * array that holds all DataSets the ChartStatusData object represents
     */
    ...
    /**
     * Call this method to let the ChartStatusData know that the underlying data has
    ...
    /**
     * Returns all DataSet objects this ChartStatusData object holds.
     *
     * @return
     */
    ...
    /**
     * Retrieve the index of a DataSet with a specific label from the ChartStatusData.
